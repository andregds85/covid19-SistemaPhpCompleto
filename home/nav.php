...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">
    <img src="logo/2.jpg" width="30" height="30" class="d-inline-block align-top" alt="">
    Covid19
  </a>
</nav>
...
Covid19  </a>
 ...
 <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    ...
    <form class="form-inline my-2 my-lg-0"  method="post" action="covid/valida_usuario.php">
